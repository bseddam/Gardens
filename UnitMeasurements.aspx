<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UnitMeasurements.aspx.cs" Inherits="UnitMeasurements" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section id="about" class="about section-bg">
        <div class="container">
            ...
            <asp:LinkButton ID="btnAdd" runat="server" CommandArgument="add" OnClick="LnkPnlMenu_Click" CssClass="btn btn-dark">Yeni ölçü vahidi əlavə et</asp:LinkButton>
                        ...
                        <dx:ASPxGridView ID="Grid" runat="server"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn VisibleIndex="1">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" OnClick="lnkEdit_Click" CommandArgument='<%#Eval("UnitMeasurementID") %>' Text="Düzəliş" runat="server" />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                ...
                                <dx:GridViewDataColumn VisibleIndex="1">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="lnkDelete" OnClick="lnkDelete_Click" OnClientClick="return confirm('Silmək istədiyinizə əminsinizmi?');" CommandArgument='<%#Eval("UnitMeasurementID") %>' Text="Sil" runat="server" />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                ...
                                <dx:PopupControlContentControl>
                                    <div class="container">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-7">
                                                <asp:TextBox ID="txtunitmeasurementname" runat="server" class="form-control"  placeholder="Mətni daxil edin..."></asp:TextBox>
                                                ...
                                                <asp:RequiredFieldValidator CssClass="requiredstyle" ValidationGroup="qrup1" ControlToValidate="txtunitmeasurementname" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Mütləq doldurulmalıdır." ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
