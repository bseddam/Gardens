<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Cards.aspx.cs" Inherits="Cards" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">
                        <asp:LinkButton ID="btnAdd" runat="server" CommandArgument="add" OnClick="LnkPnlMenu_Click" CssClass="btn btn-info">Yeni kart əlavə et</asp:LinkButton>
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    ...
                                    <dx:ASPxGridView ID="Grid" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataColumn Caption="Kartın barkodu" FieldName="CardBarcode" VisibleIndex="1">
                                                <EditFormSettings VisibleIndex="1" />
                                            </dx:GridViewDataColumn>
                                            ...
                                            <dx:GridViewDataColumn VisibleIndex="1">
                                                <DataItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" OnClick="lnkDelete_Click" OnClientClick="return confirm('Silmək istədiyinizə əminsinizmi?');" CommandArgument='<%#Eval("CardID") %>' Text="Sil" runat="server" />
                                                </DataItemTemplate>
                                            </dx:GridViewDataColumn>
                                        </Columns>
                                    </dx:ASPxGridView>
                                        ...
                                        <ContentCollection>
                                            <dx:PopupControlContentControl>
                                                <div class="container">
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="exampleInputUsername3" class="col-sm-5 col-form-label">Kartın barkodu</label>
                                                        <div class="col-sm-7">
                                                            <asp:TextBox ID="txtcardbarkod" class="form-control mb-0 mt-0" runat="server" placeholder="Kartın barkodunu daxil edin...">
                                                            </asp:TextBox>
                                                            <asp:RegularExpressionValidator ValidationGroup="qrup1" Display="Dynamic" ControlToValidate="txtcardbarkod" ID="RegularExpressionValidator2" ValidationExpression="^[\s\S]{3,500}$" runat="server" ForeColor="Red" ErrorMessage="Mətn 3 simvoldan cox olmalıdır."></asp:RegularExpressionValidator>
                                                            <asp:RequiredFieldValidator CssClass="requiredstyle" ValidationGroup="qrup1" ControlToValidate="txtcardbarkod" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Mütləq doldurulmalıdır." ForeColor="Red"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <asp:TextBox ID="txtcardnumber" class="form-control mb-0 mt-0" runat="server" placeholder="Kartın nömrəsini daxil edin...">
                                                            </asp:TextBox>
                                                           
                                                            <asp:RequiredFieldValidator CssClass="requiredstyle" ValidationGroup="qrup1" ControlToValidate="txtcardnumber" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Mütləq doldurulmalıdır." ForeColor="Red"></asp:RequiredFieldValidator>
