                    ...
                    <div class="card-body">                      
                           ...
                           <dx:ASPxGridView ID="Grid" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataColumn Caption="Əməliyyat növü" FieldName="OperationStockTypeName" VisibleIndex="1">
                                                    <EditFormSettings VisibleIndex="1" />
                                                </dx:GridViewDataColumn>
                                                ...
                                                <dx:GridViewDataColumn Caption="Qiyməti" FieldName="Price" VisibleIndex="1">
                                                  ...
                                                  <dx:GridViewDataColumn Caption="Endirim" FieldName="PriceDiscount" VisibleIndex="1">
                                                    <EditFormSettings VisibleIndex="1" />
                                                </dx:GridViewDataColumn>
                                                ...
                                                <dx:GridViewDataColumn VisibleIndex="1">
                                                    <DataItemTemplate>
                                                        <asp:LinkButton ID="lnkEdit" OnClick="lnkEdit_Click" CommandArgument='<%#Eval("ProductStockID") %>' Text="Düzəliş" runat="server" />
                                                    </DataItemTemplate>
                                                </dx:GridViewDataColumn>

                                                <dx:GridViewDataColumn VisibleIndex="1">
                                                    <DataItemTemplate>
                                                        <asp:LinkButton ID="lnkDelete" OnClick="lnkDelete_Click" OnClientClick="return confirm('Silmək istədiyinizə əminsinizmi?');" CommandArgument='<%#Eval("ProductStockID") %>' Text="Sil" runat="server" />
                                                    </DataItemTemplate>
                                                </dx:GridViewDataColumn>
                                                ...
                                                <dx:PopupControlContentControl>
                                                    <div class="container">
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <dx:ASPxComboBox ID="cmOperationType" 
                                                                    runat="server"
                                                         ...
                                                         <div class="row mb-2">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <dx:ASPxComboBox ID="cmProductName" 
                                                                    runat="server"
                                                                    Width="100%" Height="30px">
                                                                </dx:ASPxComboBox>
                                                            </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtProductDiscount" class="form-control mb-0 mt-0" runat="server" placeholder="Mətni daxil edin...">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-2">
