                    ...
                    <div class="card-body">                      
                           ...
                           <dx:ASPxGridView ID="Grid" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataColumn Caption="Xərcin adı" FieldName="ExpensesName" VisibleIndex="1">
                                                    <EditFormSettings VisibleIndex="1" />
                                                </dx:GridViewDataColumn>
                                                 <dx:GridViewDataColumn Caption="Məbləğ" FieldName="ExpensesPrice" VisibleIndex="1">
                                                    <EditFormSettings VisibleIndex="1" />
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataColumn Caption="Qeyd" FieldName="ExpensesNote" VisibleIndex="1">
                                                    <EditFormSettings VisibleIndex="1" />
                                                </dx:GridViewDataColumn>
                                                ...
                                                <dx:GridViewDataColumn VisibleIndex="1">
                                                    <DataItemTemplate>
                                                        <asp:LinkButton ID="lnkEdit" OnClick="lnkEdit_Click" CommandArgument='<%#Eval("ExpensesID") %>' Text="Düzəliş" runat="server" />
                                                    </DataItemTemplate>
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataColumn VisibleIndex="1">
                                                    <DataItemTemplate>
                                                        <asp:LinkButton ID="lnkDelete" OnClick="lnkDelete_Click" OnClientClick="return confirm('Silmək istədiyinizə əminsinizmi?');" CommandArgument='<%#Eval("ExpensesID") %>' Text="Sil" runat="server" />
                                                    </DataItemTemplate>
                                                </dx:GridViewDataColumn>
                                                ...
                                                <dx:PopupControlContentControl>
                                                    <div class="container">
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtExpensesName" class="form-control mb-0 mt-0" runat="server" placeholder="Mətni daxil edin...">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div> 
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtExpensesNote" class="form-control mb-0 mt-0" runat="server" placeholder="Mətni daxil edin..." TextMode="MultiLine">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div> 
                                                         <div class="row  mb-2">
