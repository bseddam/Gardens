                                ...
                                <dx:PopupControlContentControl>
                                    <div class="container">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-7">
                                                <asp:TextBox ID="txtgardenname" runat="server" class="form-control mb-0 mt-0" Height="50px" placeholder="Mətni daxil edin..."></asp:TextBox>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-7">
                                                <asp:TextBox ID="txtgardenarea" Height="50px" class="form-control mb-0 mt-0" runat="server" placeholder="Mətni daxil edin...">
                                                </asp:TextBox>
