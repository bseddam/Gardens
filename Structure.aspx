                                                ...
                                                <dx:PopupControlContentControl>
                                                    <div class="container">
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtsort" class="form-control mb-0 mt-0" runat="server" placeholder="Sıra nömrəsini daxil edin...">
                                                                </asp:TextBox>
                                                                <asp:CompareValidator ID="cv1" runat="server" ControlToValidate="txtsort" ErrorMessage="Format düzgün deyil." Operator="DataTypeCheck" Type="Double" ValidationGroup="qrup1" Display="Dynamic" ForeColor="Red" />
