      ...
      <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
            <div class="content-wrapper">
                <div class="card">
                    <div class="card-body">                      
                            <asp:LinkButton ID="btnAdd" runat="server" CommandArgument="add" OnClick="LnkPnlMenu_Click" CssClass="btn btn-info">Yeni suvarma sistemi əlavə et</asp:LinkButton>
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        <dx:ASPxPopupControl ID="popupEdit"
                                            ...
                                            <ContentCollection>
                                                <dx:PopupControlContentControl>
                                                    <div class="container">
                                                        <div class="row mb-2">
                                                            <label for="exampleInputUsername3" class="col-sm-5 col-form-label">Sistemin markası</label>
                                                            <div class="col-sm-7">
