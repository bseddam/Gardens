                                ...
                                <div class="table-responsive">
                                    ...
                                    <dx:ASPxGridView ID="Grid" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataColumn Caption="X koordinatı" FieldName="XCoordinate" VisibleIndex="1">
                                                <EditFormSettings VisibleIndex="1" />
                                            </dx:GridViewDataColumn>
                                            <dx:GridViewDataColumn Caption="Y koordinatı" FieldName="YCoordinate" VisibleIndex="1">
                                                <EditFormSettings VisibleIndex="1" />
                                            </dx:GridViewDataColumn>
                                        ...
                                        <ContentCollection>
                                            <dx:PopupControlContentControl>
                                                <div class="container">
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="exampleInputUsername3" class="col-sm-3 col-form-label">X koordinatı</label>
                                                        <div class="col-sm-9">
                                                            <asp:TextBox ID="txtYCoordinate" class="form-control" runat="server" placeholder="Mətni daxil edin...">
                                                            </asp:TextBox>
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="exampleInputUsername3" class="col-sm-3 col-form-label">Y koordinatı</label>
                                                        <div class="col-sm-9">
                                                            <asp:TextBox ID="txtXCoordinate" class="form-control" runat="server" placeholder="Mətni daxil edin...">
                                                            </asp:TextBox>
