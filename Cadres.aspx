...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <asp:LinkButton ID="btnAdd" runat="server" CommandArgument="add" OnClick="LnkPnlMenu_Click" CssClass="btn btn-dark">Yeni kadr əlavə et</asp:LinkButton>
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive">
                            ...
                            <dx:ASPxGridView ID="Grid" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn Caption="Şəkil" FieldName="Photo" VisibleIndex="1">
                                        <DataItemTemplate>
                                            <img src="imgcadres/<%#Eval("Photo") %>" width="50" height="50" />
                                        </DataItemTemplate>
                                        <EditFormSettings VisibleIndex="1" />
                                    </dx:GridViewDataColumn>
